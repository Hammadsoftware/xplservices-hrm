...
const billingTypes = [
  { id: 1, name: "A", rate: 200 },
  { id: 2, name: "B", rate: 150 },
  { id: 3, name: "C", rate: 100 },
];
...
export default function BillingTypesPage() {
  const handleDelete = (id) => {
    ...
    // 🔥 Replace this with API / server action
    console.log("Deleted billing type:", id);
  };
      ...
      <section className="relative flex flex-col gap-6 md:flex-row md:items-center md:justify-between">
        <div>
          ...
          <p className="text-gray-600">
            Manage billing categories and rates
          </p>
        </div>

        {/* ADD BUTTON */}
        <Link href="/dashboard/settings/billing-types/add">
          <button
            ...
            <table className="w-full min-w-[700px] text-sm">
              <thead>
                <tr className="bg-gradient-to-r from-sky-500 via-blue-600 to-indigo-700 text-white">
                  <th className="px-6 py-4 text-left">Billing Name</th>
                  ...
                  >
                    ...
                    <td className="px-6 py-4 text-center">
                      <div className="flex items-center justify-center gap-4">
                        ...
                        {/* EDIT */}
                        <Link
                          href={`/dashboard/settings/billing-types/${item.id}/edit`}
