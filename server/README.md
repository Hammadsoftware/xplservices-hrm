...
- Create a Neon account at [https://console.neon.tech](https://console.neon.tech)
- Create a new project and database
- Copy your connection string (it will look like: `postgresql://user:password@ep-xxxxx.us-east-1.neon.tech/dbname?sslmode=require`)
